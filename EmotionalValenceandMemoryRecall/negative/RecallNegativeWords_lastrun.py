...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('negwordlist.csv'),
    ...
    for thisTrial_4 in trials_4:
        ...
        while continueRoutine and routineTimer.getTime() < 10.0:
            ...
            if TestAns.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > TestAns.tStartRefresh + 10-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if Instr.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > Instr.tStartRefresh + 10-frameTolerance:
                    # keep track of stop time/frame for later
