...
expName = 'MotorSequenceLearning'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\POOJA\\OneDrive\\Desktop\\Stud-ious\\Sem-5\\PSY310\\PsychoPy\\Session-6(MotorSequence Learning)\\MotorSequenceLearning_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    triangle = visual.ShapeStim(
        win=win, name='triangle',units='pix', 
    ...
    trials = data.TrialHandler(nReps=50.0, method='sequential', 
        ...
        trialList=data.importConditions('sequence_cond.csv'),
    ...
    for thisTrial in trials:
        ...
        triangle.setPos((pos, 60))
        # create starting attributes for key_resp
        key_resp.keys = []
        key_resp.rt = []
        _key_resp_allKeys = []
        # keep track of which components have finished
        trialComponents = [fixation, line1, line2, line3, line4, triangle, key_resp]
        ...
        while continueRoutine:
            ...
            if triangle.status == NOT_STARTED and tThisFlip >= 2.0-frameTolerance:
                # keep track of start time/frame for later
