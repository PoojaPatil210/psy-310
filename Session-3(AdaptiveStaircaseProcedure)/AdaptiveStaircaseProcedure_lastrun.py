...
expName = 'AdaptiveStaircaseProcedure'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\POOJA\\OneDrive\\Desktop\\Stud-ious\\Sem-5\\PSY310\\PsychoPy\\Session-3(AdaptiveStaircaseProcedure)\\AdaptiveStaircaseProcedure_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    grating = visual.GratingStim(
        ...
        ori=1.0, pos=(0, 0), size=(0.3, 0.3), sf=10.0, phase=0.0,
    ...
    stair = data.StairHandler(startVal=20.0, extraInfo=expInfo,
        stepSizes=[2,1,1,0.5], stepType='lin',
        nReversals=0.0, nTrials=150.0, 
        nUp=1.0, nDown=3.0,
        minVal=0.1, maxVal=50.0,
        originPath=-1, name='stair')
    thisExp.addLoop(stair)  # add the loop to the experiment
    level = thisStair = 20.0  # initialise some vals
