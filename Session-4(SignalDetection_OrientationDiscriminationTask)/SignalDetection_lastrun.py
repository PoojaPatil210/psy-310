...
expName = 'SignalDetection'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\POOJA\\OneDrive\\Desktop\\Stud-ious\\Sem-5\\PSY310\\PsychoPy\\Session-4(SignalDetection_OrientationDiscriminationTask)\\SignalDetection_lastrun.py',
