...
expName = 'IntentionalBindingTask'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\POOJA\\OneDrive\\Desktop\\Stud-ious\\Sem-5\\PSY310\\PsychoPy\\Session-9(IntentionalBindingTask)\\IntentionalBindingTask_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between the key press and the beep sound (0-999 ms): Click submit after entering the value',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=34.0, method='random', 
        ...
        trialList=data.importConditions('ib_cons.csv'),
